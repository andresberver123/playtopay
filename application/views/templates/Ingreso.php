...
<div id="contentwrapper">
    ...
    <section>
        <div class="login-wrap">
            <div class="mensaje">
                <h2>Prueba tecnica Andres Bernal - Login</h2>
            </div>            
            
            <h3>Datos de ingreso</h3>
            email: <b>andresprueba@gmail.com</b><br>
            password: <b>123456</b>          
            
            <form id="form-logeo" class="generic" method="POST" action="<?= base_url() ?>ingreso/entrar">
